...
exports.demoClassDecorator = demoClassDecorator;
// Простой декоратор класса 
function sealed(constructor) {
    console.log("\u041A\u043B\u0430\u0441\u0441 ".concat(constructor.name, " \u0437\u0430\u043F\u0435\u0447\u0430\u0442\u0430\u043D"));
    Object.seal(constructor);
    Object.seal(constructor.prototype);
}
// Декоратор с логированием
function logger(constructor) {
    console.log("\u0421\u043E\u0437\u0434\u0430\u043D \u043A\u043B\u0430\u0441\u0441: ".concat(constructor.name));
}
var User = function () {
    var _classDecorators = [sealed, logger];
...
var Product = function () {
    var _classDecorators = [addTimestamp];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
...
function demoClassDecorator() {
    ...
    var product = new Product("Ноутбук", 50000); // eslint-disable-line @typescript-eslint/no-explicit-any
