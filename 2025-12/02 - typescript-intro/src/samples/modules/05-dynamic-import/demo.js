...
exports.demoDynamicImport = demoDynamicImport;
function demoDynamicImport() {
    return __awaiter(this, void 0, void 0, function () {
        var mathModule, loggerModule, Logger, logger, isDevelopment, devTools;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require("../01-basic-exports/math"); })];
                case 1:
                    mathModule = _a.sent();
                    ...
                    console.log("\nЗагрузка Logger...");
                    return [4 /*yield*/, Promise.resolve().then(function () { return require("../02-default-export/logger"); })];
                case 2:
                    loggerModule = _a.sent();
