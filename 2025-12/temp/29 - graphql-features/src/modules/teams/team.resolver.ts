...
export class TeamResolver {
  ...
  async getMembers(@Parent() team: Team) {
    console.log('team', team.id); // 1, 2, 3 => [1, 2, 3]
...
// 1 варинат - возвращать всё и делать запрос на получения всего teams + join users
// 2 вариант - запрашивать данные по мере указания в запросе. Если не указан members, то запрос на получение users не делаем.