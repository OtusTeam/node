...
Стиль архитектурный, для разработки веб сервисов, который позволяет взаимодействовать системам друг с другом HTTP

HTTP - язык взаимодействия.

HTTP Request - формат запроса.
HTTP Response - формат ответ
