...
- Альтернативы
  ...
  - bower
.right-image[
  ![node modules black hole](assets/node-modules-black-hole.png)
]
...
### Использовать хотя бы Node@10 для стандартного импорта
...
# Спасибо за внимание!
.black[ 
## Пожалуйста, пройдите [опрос](https://otus.ru/polls/9702/)
## в личном кабинете 
]
